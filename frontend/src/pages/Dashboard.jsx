...
const Dashboard = () => {
  ...
  return (
    <>
      <title>Dashboard | CodeSlayer</title>
      <meta
        name="description"
        content="View your coding stats, recent activity, submissions, and personalized recommendations on your CodeSlayer dashboard."
      />
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="space-y-2 text-white">
              <p>
                ...
                <span className="font-semibold text-green-400">
                  {dashboardData.solvedByDifficulty.Easy}
                </span>
              </p>
              <p>
                Medium:{" "}
                <span className="font-semibold text-yellow-400">
                  {dashboardData.solvedByDifficulty.Medium}
                </span>
              </p>
              <p>
                Hard:{" "}
                <span className="font-semibold text-red-400">
                  {dashboardData.solvedByDifficulty.Hard}
                </span>
              </p>
            </div>
          </Card>
          ...
          <Card className="lg:col-span-1 md:col-span-2">
            {" "}
            {/* Adjusted col-span to take remaining space */}
            <h2 className="text-xl font-bold mb-4 text-gray-100">
              Upcoming Contests
            </h2>
            <div className="space-y-4">
