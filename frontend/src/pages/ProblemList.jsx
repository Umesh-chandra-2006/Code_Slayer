...
const ProblemList = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        difficultyFilterRef.current &&
        !difficultyFilterRef.current.contains(event.target)
      ) {
      ...
      if (
        ...
        !publishedFilterRef.current.contains(event.target)
      ) {
  ...
  return (
    <>
      <title>Problems | CodeSlayer</title>
      <meta
        name="description"
        content="Browse algorithmic challenges across various topics and difficulties. Solve problems to improve your programming skills."
      />
      <div className="container mx-auto p-6 bg-gradient-to-br from-gray-900 to-black min-h-screen text-white font-sans">
        ...
        <div className="mb-6 bg-neutral-900 p-5 rounded-lg shadow-xl border border-neutral-700">
              ...
              <div className="relative" ref={publishedFilterRef}>
                ...
                >
                  ...
                  <span>
                    Status:{" "}
                    {
                      publishedOptions.find((o) => o.value === publishedFilter)
                        ?.label
                    }
                  </span>
                </Button>
                    ...
                    {publishedOptions.map((option) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            handlePublishedFilterChange(option.value)
                          }
                ...
                <div className="absolute z-10 mt-2 w-48 bg-neutral-800 rounded-lg shadow-lg border border-neutral-700 p-2 text-white">
                  ...
                  <label className="flex items-center p-2 rounded-md hover:bg-neutral-700 cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        handleSortChange("problemNumber", sortOrder)
                      }
                      className="form-radio h-4 w-4 text-blue-500"
                    />
                  ...
                  <label className="flex items-center p-2 rounded-md hover:bg-neutral-700 cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        handleSortChange("acceptanceRate", sortOrder)
                      }
                      className="form-radio h-4 w-4 text-blue-500"
                    />
          ...
          <div className="flex flex-wrap items-center gap-2 text-gray-400 text-sm">
            ...
            {selectedDifficulties.length > 0 && (
              <span>Difficulty: {selectedDifficulties.join(", ")}</span>
            )}
            {/* Display selected published filter */}
            {isAdmin && publishedFilter !== "all" && (
              <span>
                Status:{" "}
                {
                  publishedOptions.find((o) => o.value === publishedFilter)
                    ...
                    {isAdmin && (
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex gap-2">
                          <Link to={`/problems/${problem.slug}/edit`}>
                            <Button
                              variant="secondary"
