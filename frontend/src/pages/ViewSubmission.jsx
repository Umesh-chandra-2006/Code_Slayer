...
const ViewSubmission = () => {
  ...
  useEffect(() => {
    if (submission && submission.problem && submission.problem.title) {
      document.title = `Submission – ${submission.problem.title} | CodeSlayer`;
      ...
      metaDesc.content = `View detailed result and feedback for your submission on the problem '${submission.problem.title}' at CodeSlayer, including verdict, code, and performance.`;
    }
  }, [submission]);
  ...
  if (!submission) {
    return (
      <div className="text-gray-400 text-center text-lg mt-10 p-4 bg-gray-800 rounded-lg shadow-xl mx-auto max-w-lg">
  ...
  return (
    <>
      <title>Submission - [Problem Name] | CodeSlayer</title>
      <meta
        name="description"
        content="View detailed result and feedback for your submission #[id] on CodeSlayer, including verdict, problem details, and submitted code."
      />
              ...
              <>
                ...
                {submission.problem.description && (
                  <p className="text-sm text-gray-400 mt-1">
                    {submission.problem.description.substring(0, 100)}
                    {submission.problem.description.length > 100 ? "..." : ""}
                  </p>
                )}
              </>
            ) : (
              <p className="text-xl text-gray-400">
                Problem Details Not Found or Not Linked
              </p>
            )}
          </div>
          <div>
