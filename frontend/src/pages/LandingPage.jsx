...
export default function LandingPage() {
  ...
  return (
    <>
      <title>CodeSlayer - Slay the code</title>
      <meta
        name="description"
        content="Solve algorithmic challenges, test your solutions in real-time, and sharpen your programming skills on CodeSlayer."
      />
        ...
        <nav className="px-6 py-5 flex justify-between items-center relative z-10 container mx-auto">
          <div className="flex items-center gap-3">
            <img
              src="/icon.png"
              alt="CodeSlayer Logo"
              className="w-9 h-9 rounded-lg shadow-lg object-contain bg-black"
            />
            <h1 className="text-3xl font-extrabold bg-gradient-to-r from-red-500 to-pink-600 bg-clip-text text-transparent tracking-tight font-mono">
              CodeSlayer
            </h1>
          </div>
          <div>
          ...
          <div className="container mx-auto px-6 py-20 md:py-32 text-center relative z-0">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                Solve algorithmic challenges, test your solutions in real-time,
                and{" "}
            ...
            >
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Run and test your code against various test cases instantly
                  with our lightning-fast compiler.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Monitor your submissions, track your ranking, and visualize
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-blue-200 mb-12 max-w-3xl mx-auto">
                Join our thriving community and start your journey towards
